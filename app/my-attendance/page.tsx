...
const copy = {
  ...
  zh: {
    title: "我的打卡",
    subtitle: "必须人在店里，并允许手机获取位置。",
    loading: "正在加载打卡信息…",
    unavailable: "暂时无法加载打卡系统。",
    entrance: "上班",
    exit: "下班",
    nextEntrance: "确认上班",
    nextExit: "确认下班",
    ...
    sending: "正在保存打卡…",
    ready: "位置验证成功",
    locationNeeded: "点击打卡时会重新获取当前位置。",
    locationDenied: "请在浏览器设置中允许本网站使用位置。",
    locationUnavailable: "定位不够准确，请靠近窗户后重试。",
    offline: "打卡需要联网验证当前位置。",
    success: "打卡成功",
    today: "今日记录",
    noEvents: "今天还没有打卡。",
    refresh: "刷新",
    logout: "退出登录",
    insideOnly: "仅限餐厅范围内打卡",
