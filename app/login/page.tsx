    ...
    <div className="flex min-h-[100dvh] items-center justify-center bg-gray-50 p-4">
      <div className="w-full max-w-md rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
        <div className="mb-6 text-center">
          ...
          <h1 className="text-xl font-bold text-gray-900">Iniciar sesión en Karuma ERP</h1>
          <p className="mt-1 text-sm text-gray-500">Empleados: PIN. Administradores: cuenta.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <label className="block space-y-1.5">
            ...
            <input
              ...
              placeholder="PIN de empleado o karuma"
